...
export default function ProjectPage() {
  ...
  const { default: Content, frontmatter } = useMemo(() => {
    const match = Object.entries(projectModules).find(
          ...
          <section>
            ...
            <div className="flex items-center gap-4 lg:gap-8">
              {frontmatter.link && frontmatter.link.length > 0 && (
                <a href={frontmatter.link} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2">
              ...
              {frontmatter.github && frontmatter.github.length > 0 && (
                <a href={frontmatter.github} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2">
